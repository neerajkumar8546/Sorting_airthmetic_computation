...
do
    ...
    do
        ...
        if [ ${store_result_toArray[j]} -lt ${store_result_toArray[$((j+1))]} ] 
        then
            # swap 
            temp=${store_result_toArray[j]} 
            store_result_toArray[$j]=${store_result_toArray[$((j+1))]}   
            store_result_toArray[$((j+1))]=$temp 
        fi
    done
done
...
printf "\n"
#print sorted array desending order
echo "print sorted array descending order : "
printf "\n"
echo ${store_result_toArray[@]}
